    ...
    <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/admin/listowners">List Owners</a>
              </li> 
            <li class="nav-item active">
                <a class="nav-link" href="/admin/listfacilities">List Facilities</a>
              </li> 
            <li class="nav-item active">
                <a class="nav-link" href="/admin/listvendors">List Vendors</a>
            </li> 
            <li class="nav-item active">
                <a class="nav-link" href="/admin/listprojects">List Projects</a>
            </li> 
            <li class="nav-item active">
                <a class="nav-link" href="/admin/listservices">List Services</a>
            </li> 
            <li class="nav-item active">
