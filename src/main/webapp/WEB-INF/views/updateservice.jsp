...
<html>
    ...
    <body>
        <form:form method="post" modelAttribute="service" action="/admin/updateservice" role="form">
            <input type="hidden" value="${service.serviceid}" name="serviceid" class="form-control" id="serviceid"
            ...
            <input type="time" value="${service.startTime}" name="startTime" class="form-control" id="startTime"
            placeholder="start time" required ="true" >
            <input type="time" value="${service.endTime}" name="endTime" class="form-control" id="endTime"
